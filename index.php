  ...
  <head>
    ...
    <title>Heroes of Blood Selayar </title>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 col-sm-9">
            <div class="left-info">
              <ul>
                <li><a href="#"><i class="fa fa-phone"></i>+6285 825 272 451</a></li>
                <li><a href="#"><i class="fa fa-envelope"></i>asmar.me.id@gmail.com</a></li>
                <li><a href="#"><i class="fa fa-map-marker"></i>Kab. Kepulauan Selayar</a></li>
              </ul>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-lg-7">
            <div class="caption header-text">
              <h4><em>SELAMAT DATANG</em></h4>
              <div class="line-dec"></div>
              <h4>Aplikasi <em>Bank Darah</em><br><em style="font-size:75%; color:red;" >Komunitas Heroes Of Blood</em></h4>
              <p>Jadilah bagian dari komunitas pahlawan yang siap menolong kapan pun dibutuhkan. Setiap tetes darah yang Anda donorkan adalah bukti nyata bahwa kepedulian masih hidup di dunia ini.
              <div class="main-button scroll-to-section"><a href="#services">Lihat Sebagai Tamu</a></div>
              <span>or</span>
              <div class="second-button"><a href="bloodbank/../admin/index.php">Masuk Sebagai Pendonor</a></div>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="section-heading">
                  <h2>Kelola <em>Donor, Permintaan, &amp; Stok Darah</em> 
                    Secara<span>Efisien</span>
                  </h2>
                  <div class="line-dec"></div>
              ...
              <div class="col-lg-6 col-sm-6">
                <div class="service-item">
                  ...
                  <h4>Jumlah Stok Darah</h4>
                  <h4> <?php echo $conn->query("SELECT * FROM blood_inventory where status = 1 and date(date_created) = '".date('Y-m-d')."' ")->num_rows ?></h4>
                </div>
              </div>
              <div class="col-lg-6 col-sm-6">
                <div class="service-item">
              ...
              <div class="col-lg-6 col-sm-6">
                <div class="service-item">
                  ...
                  <h4>Jumlah Permintaan Darah</h4>
                  <h4><?php echo $conn->query("SELECT * FROM requests where date(date_created) = '".date('Y-m-d')."' ")->num_rows ?></h4>
                </div>
              </div>
              <div class="col-lg-6 col-sm-6">
                <div class="service-item">
                  ...
                  <h4>Permintaan Darah Yang Terpenuhi </h4>
                  <h4><?php echo $conn->query("SELECT * FROM requests where date(date_created) = '".date('Y-m-d')."' and status = 1 ")->num_rows ?>
                </div>
              </div>
            </div>
          </div>
